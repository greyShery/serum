#!/bin/bash
# ============================================================================
# SERUM P0 (smooth loss) 评估脚本 — 单 GPU（GPU0）
# ============================================================================
# 训练产物:
...
#
# 用法:
#   bash eval_p0fix_single_gpu.sh                  # 默认 1000 samples
#   NUM_SAMPLES=500 bash eval_p0fix_single_gpu.sh # 自定义样本数
# ============================================================================
...
echo "============================================================"
echo "SERUM P0 评估 — 单 GPU (GPU$GPU)"
